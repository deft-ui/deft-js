...
test('return help usage how to use create-deft', () => {
  const { stdout } = run(['--help'], { cwd: __dirname })
  const message = 'Usage: create-deft [OPTION]... [DIRECTORY]'
  expect(stdout).toContain(message)
})

test('return help usage how to use create-deft with -h alias', () => {
